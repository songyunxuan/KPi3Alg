...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(KPi3Alg_tag).make
cmt_local_tagfile = $(bin)$(KPi3Alg_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_KPi3Algsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_KPi3Algsetup.make
else
#cmt_local_setup = $(bin)KPi3Algsetup$(cmt_lock_pid).make
...
KPi3Alg_extratags = -tag_add=target_KPi3Alg

#$(cmt_local_tagfile_KPi3Alg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_KPi3Alg) ::
else
$(cmt_local_tagfile_KPi3Alg) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_KPi3Alg)"
	@if test -f $(cmt_local_tagfile_KPi3Alg); then /bin/rm -f $(cmt_local_tagfile_KPi3Alg); fi ; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_extratags) build tag_makefile >>$(cmt_local_tagfile_KPi3Alg); \
	  if test -f $(cmt_final_setup_KPi3Alg); then /bin/rm -f $(cmt_final_setup_KPi3Alg); fi; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_extratags) show setup >>$(cmt_final_setup_KPi3Alg)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_KPi3Alg_makefile) :: $(KPi3Alg_dependencies) $(cmt_local_tagfile_KPi3Alg) build_library_links dirs
else
$(cmt_local_KPi3Alg_makefile) :: $(cmt_local_tagfile_KPi3Alg)
endif
	$(echo) "(constituents.make) Building KPi3Alg.make"; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_extratags) build constituent_makefile -out=$(cmt_local_KPi3Alg_makefile) KPi3Alg

KPi3Alg :: $(KPi3Alg_dependencies) $(cmt_local_KPi3Alg_makefile)
	$(echo) "(constituents.make) Starting KPi3Alg"
	@$(MAKE) -f $(cmt_local_KPi3Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} KPi3Alg
	$(echo) "(constituents.make) KPi3Alg done"

clean :: KPi3Algclean

KPi3Algclean :: $(KPi3Algclean_dependencies) ##$(cmt_local_KPi3Alg_makefile)
	$(echo) "(constituents.make) Starting KPi3Algclean"
	@-if test -f $(cmt_local_KPi3Alg_makefile); then \
	  $(MAKE) -f $(cmt_local_KPi3Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} KPi3Algclean; \
	fi

##	  /bin/rm -f $(cmt_local_KPi3Alg_makefile) $(bin)KPi3Alg_dependencies.make

install :: KPi3Alginstall

KPi3Alginstall :: $(KPi3Alg_dependencies) $(cmt_local_KPi3Alg_makefile)
	$(echo) "(constituents.make) Starting install KPi3Alg"
	@-$(MAKE) -f $(cmt_local_KPi3Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install KPi3Alg done"

uninstall :: KPi3Alguninstall

KPi3Alguninstall :: $(cmt_local_KPi3Alg_makefile)
	$(echo) "(constituents.make) Starting uninstall KPi3Alg"
	@-$(MAKE) -f $(cmt_local_KPi3Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall KPi3Alg done"
...
$(cmt_local_tagfile_install_runtime) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_install_runtime)"
	@if test -f $(cmt_local_tagfile_install_runtime); then /bin/rm -f $(cmt_local_tagfile_install_runtime); fi ; \
	  ...
	  if test -f $(cmt_final_setup_install_runtime); then /bin/rm -f $(cmt_final_setup_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(install_runtime_extratags) show setup >>$(cmt_final_setup_install_runtime)
	$(echo) setup.make ok
...
install_runtime :: $(install_runtime_dependencies) $(cmt_local_install_runtime_makefile)
	$(echo) "(constituents.make) Creating install_runtime${lock_suffix} and Starting install_runtime"
	@${lock_command} install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install_runtime; \
	  retval=$$?; ${unlock_command} install_runtime${lock_suffix}; exit $${retval}
...
install_runtimeclean :: $(install_runtimeclean_dependencies) ##$(cmt_local_install_runtime_makefile)
	...
	@-if test -f $(cmt_local_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install_runtimeclean; \
	fi
...
install_runtimeinstall :: $(install_runtime_dependencies) $(cmt_local_install_runtime_makefile)
	...
	@-$(MAKE) -f $(cmt_local_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install install_runtime done"

uninstall :: install_runtimeuninstall

install_runtimeuninstall :: $(cmt_local_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall install_runtime"
	@-$(MAKE) -f $(cmt_local_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(KPi3Alg_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_KPi3Alg_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(KPi3Alg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(KPi3Alg_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)KPi3Alg_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_KPi3Algsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(KPi3Alg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_install_includes = $(bin)KPi3Algsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(KPi3Alg_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_KPi3Alg_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(KPi3Alg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(KPi3Alg_tag)_make.make
cmt_final_setup_make = $(bin)KPi3Alg_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_KPi3Algsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(KPi3Alg_tag).make
cmt_local_tagfile_make = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_make = $(bin)KPi3Algsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(KPi3Alg_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_KPi3Alg_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(KPi3Alg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(KPi3Alg_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)KPi3Alg_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_KPi3Algsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(KPi3Alg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_CompilePython = $(bin)KPi3Algsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(KPi3Alg_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_KPi3Alg_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(KPi3Alg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(KPi3Alg_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)KPi3Alg_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_KPi3Algsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(KPi3Alg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_qmtest_run = $(bin)KPi3Algsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(KPi3Alg_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_KPi3Alg_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(KPi3Alg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KPi3Alg_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)KPi3Alg_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_KPi3Algsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(KPi3Alg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)KPi3Algsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(KPi3Alg_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_KPi3Alg_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(KPi3Alg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(KPi3Alg_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)KPi3Alg_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_KPi3Algsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(KPi3Alg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_TestPackage = $(bin)KPi3Algsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(KPi3Alg_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_KPi3Alg_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(KPi3Alg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(KPi3Alg_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)KPi3Alg_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_KPi3Algsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(KPi3Alg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_TestProject = $(bin)KPi3Algsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(KPi3Alg_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_KPi3Alg_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(KPi3Alg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(KPi3Alg_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)KPi3Alg_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_KPi3Algsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(KPi3Alg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_new_rootsys = $(bin)KPi3Algsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(KPi3Alg_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_KPi3Alg_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KPi3Alg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KPi3Alg_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KPi3Alg_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_KPi3Algsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KPi3Alg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KPi3Algsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
...
ifdef READONLY
cmt_local_tagfile_EventNavigator_check_install_runtime = /tmp/CMT_$(KPi3Alg_tag)_EventNavigator_check_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_EventNavigator_check_install_runtime = /tmp/CMT_KPi3Alg_EventNavigator_check_install_runtimesetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = /tmp/CMT_EventNavigator_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(KPi3Alg_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(KPi3Alg_tag)_EventNavigator_check_install_runtime.make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)KPi3Alg_EventNavigator_check_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_EventNavigator_check_install_runtime = /tmp/CMT_$(KPi3Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_EventNavigator_check_install_runtime = /tmp/CMT_KPi3Algsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = /tmp/CMT_EventNavigator_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(KPi3Alg_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(KPi3Alg_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)KPi3Algsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
endif
...
KPi3Alg_check_install_runtime_extratags = -tag_add=target_KPi3Alg_check_install_runtime

#$(cmt_local_tagfile_KPi3Alg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_KPi3Alg_check_install_runtime) ::
else
$(cmt_local_tagfile_KPi3Alg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_KPi3Alg_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_KPi3Alg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_KPi3Alg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_KPi3Alg_check_install_runtime); \
	  if test -f $(cmt_final_setup_KPi3Alg_check_install_runtime); then /bin/rm -f $(cmt_final_setup_KPi3Alg_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_check_install_runtime_extratags) show setup >>$(cmt_final_setup_KPi3Alg_check_install_runtime)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_KPi3Alg_check_install_runtime_makefile) :: $(KPi3Alg_check_install_runtime_dependencies) $(cmt_local_tagfile_KPi3Alg_check_install_runtime) build_library_links dirs
else
$(cmt_local_KPi3Alg_check_install_runtime_makefile) :: $(cmt_local_tagfile_KPi3Alg_check_install_runtime)
endif
	$(echo) "(constituents.make) Building KPi3Alg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(KPi3Alg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_KPi3Alg_check_install_runtime_makefile) KPi3Alg_check_install_runtime

KPi3Alg_check_install_runtime :: $(KPi3Alg_check_install_runtime_dependencies) $(cmt_local_KPi3Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating KPi3Alg_check_install_runtime${lock_suffix} and Starting KPi3Alg_check_install_runtime"
	@${lock_command} KPi3Alg_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} KPi3Alg_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_KPi3Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} KPi3Alg_check_install_runtime; \
	  retval=$$?; ${unlock_command} KPi3Alg_check_install_runtime${lock_suffix}; exit $${retval}
	$(echo) "(constituents.make) KPi3Alg_check_install_runtime done"

clean :: KPi3Alg_check_install_runtimeclean

KPi3Alg_check_install_runtimeclean :: $(KPi3Alg_check_install_runtimeclean_dependencies) ##$(cmt_local_KPi3Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting KPi3Alg_check_install_runtimeclean"
	@-if test -f $(cmt_local_KPi3Alg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_KPi3Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} KPi3Alg_check_install_runtimeclean; \
	fi

##	  /bin/rm -f $(cmt_local_KPi3Alg_check_install_runtime_makefile) $(bin)KPi3Alg_check_install_runtime_dependencies.make

install :: KPi3Alg_check_install_runtimeinstall

KPi3Alg_check_install_runtimeinstall :: $(KPi3Alg_check_install_runtime_dependencies) $(cmt_local_KPi3Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install KPi3Alg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_KPi3Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install KPi3Alg_check_install_runtime done"

uninstall :: KPi3Alg_check_install_runtimeuninstall

KPi3Alg_check_install_runtimeuninstall :: $(cmt_local_KPi3Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall KPi3Alg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_KPi3Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall KPi3Alg_check_install_runtime done"

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ KPi3Alg_check_install_runtime"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ KPi3Alg_check_install_runtime done"
endif
